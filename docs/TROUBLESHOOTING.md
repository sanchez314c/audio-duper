...
This troubleshooting guide helps you resolve common issues with AudioDUPER. Problems are organized by category with step-by-step solutions and preventive measures.
...
2. **Reduce concurrency**: The app processes files in parallel; scanning smaller batches helps
...
1. **Scan smaller batches**: Reduce the number of files processed at once
...
AudioDUPER does not currently write dedicated log files. Use the debug environment variables above and check the terminal/console output for diagnostics.
...
3. **Check [GitHub Issues](https://github.com/sanchez314c/audio-duper/issues)** for existing reports
...
- **Bug Reports**: [https://github.com/sanchez314c/audio-duper/issues](https://github.com/sanchez314c/audio-duper/issues)
- **Feature Requests**: [https://github.com/sanchez314c/audio-duper/issues](https://github.com/sanchez314c/audio-duper/issues)
- **Security Issues**: security@audioduper.com

**Community Support**:

- **GitHub Discussions**: [https://github.com/sanchez314c/audio-duper/discussions](https://github.com/sanchez314c/audio-duper/discussions)
